...
void gradientSobel(cv::Mat& img, cv::Mat& img_x, cv::Mat& img_y) {
  ...
  // EJERCICIO 1:
  // - implementar "zero padding" en el c贸mputo del gradiente
  // - analizar correlacion vs. convoluci贸n
...
int main(int argc, char** argv )
{
  ...
  // co砿puto de derivadas espaciales
  ...
  // integracio硁 oocal = Gaussian blur
